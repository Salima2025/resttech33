...
const services = [
  {
    icon: Wrench,
    title: "Оборудование",
    desc: "Новое и б/у оборудование для любого формата HoReCa — с гарантией, монтажом и обучением.",
...
const stats = [
  ...
  { value: "2–4 мес.", label: "срок окупаемости внедрения", icon: Clock },
  { value: "350+", label: "успешных проектов в HoReCa", icon: ShieldCheck },
];

const testimonials = [
  {
    quote: "После внедрения IoT-системы от Rest-Tech мы сократили потери продуктов на 28% и ускорили отдачу блюд на 15 минут в пиковые часы.",
    name: "Алексей Иванов",
    role: "Управляющий, сеть «Вкус Города»",
  },
  {
    quote: "Профессиональный аудит кухни выявил проблемы, о которых мы даже не подозревали. Окупились за 3 месяца.",
    name: "Мария Петрова",
    role: "Шеф-повар, ресторан «Нарцисс»",
  },
  {
    quote: "Б/у оборудование с гарантией от Rest-Tech позволило нам открыть вторую точку с экономией 35% на старте.",
    name: "Дмитрий Козлов",
    role: "Основатель, кафе «Дом Еды»",
  },
];
  ...
  return (
    <>
        ...
        <div className="container-tight relative z-10 py-20 md:py-32 px-4 md:px-8">
          ...
          >
            ...
            <motion.h1 custom={1} variants={fadeUp} className="text-4xl md:text-6xl font-display font-bold leading-tight mb-6">
              Экономим вашим ресторанам{" "}
              <span className="text-accent">от 15 до 40%</span>{" "}
              операционных расходов
            </motion.h1>
            <motion.p custom={2} variants={fadeUp} className="text-lg md:text-xl text-primary-foreground/75 mb-8 max-w-2xl">
              Оборудование, IoT-автоматизация и экспертный консалтинг — три направления, единый результат: ваша кухня работает быстрее, дешевле и предсказуемее.
            </motion.p>
            <motion.div custom={3} variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              <Link to="/contacts">
                <Button variant="heroOutline" size="lg">Обсудить проект</Button>
              </Link>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="section-padding bg-background">
        <div className="container-tight">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-4xl text-foreground mb-4">Три направления — единый результат</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {services.map((svc, i) => (
              ...
              >
                <Link
                  to={svc.href}
                  className="group block bg-card rounded-2xl p-6 md:p-8 shadow-card hover:shadow-elevated transition-all duration-300 border border-border hover:border-accent/30 h-full"
                >
      ...
      <section className="section-padding bg-muted/50">
        <div className="container-tight">
          <h2 className="font-display font-bold text-3xl md:text-4xl text-foreground mb-10 text-center">
      ...
      <section className="section-padding gradient-hero text-primary-foreground">
        <div className="container-tight text-center">
          <h2 className="font-display font-bold text-3xl md:text-4xl mb-4">
            Готовы оптимизировать вашу кухню?
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/calculator">
              <Button variant="hero" size="lg">
                Оценить экономику <ArrowRight className="w-4 h-4 ml-1" />
              </Button>
            </Link>
            <Link to="/contacts">
              <Button variant="heroOutline" size="lg">Связаться с нами</Button>
            </Link>
          </div>
        </div>
      </section>
